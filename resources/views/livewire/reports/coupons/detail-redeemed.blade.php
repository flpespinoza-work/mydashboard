            ...
            <div wire:loading.remove>
                <div class="flex items-center">
                    ...
                    <a
                        ...
                        target="_blank"
                        href="{{ route('reports.coupons.detail-redeemed.download', ['data' => Crypt::encrypt(['report_id' => $result['report_id'], 'report_data' => $report_data])] ) }}"
                    >
                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <div class="mt-3 overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse (array_reverse($result['coupons']) as $i => $data)
                                <tr>
