<div>
    ...
    <div class="min-h-full mt-4 lg:mt-8">
        ...
        @if (!is_null($result) && !empty($result))
            <div wire:loading.remove.shortest>
                <div class="flex items-center">
                    ...
                    <a
                        ...
                        target="_blank"
                        href="{{ route('reports.coupons.printed.download', ['data' => Crypt::encrypt(['report_id' => $result['report_id'], 'report_data' => $report_data])] ) }}"
                    >
                ...
                <div class="grid grid-cols-2 gap-4 mt-8">
                    <div class="h-64 col-span-2 p-4 border rounded-md shadow-sm bg-gray-25 border-gray-50 md:col-span-1 md:h-96">
                        ...
                        <div class="overflow-hidden border-b border-gray-200 shadow sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse (array_reverse($result['coupons']) as $data)
                                    <tr>
