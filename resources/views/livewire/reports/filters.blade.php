...
>
    <form wire:submit.prevent="sendFiltersToReport" class="items-center space-y-2 md:space-y-0 md:space-x-4 xl:justify-end md:flex">
        ...
        <div class="md:w-6/12 lg:w-5/12 xl:w-5/12 @if($hideStores) hidden @endif">
            <select
            wire:model="filters.store"
            id="selectStores" id="store"
        ...
        <div class="relative md:w-6/12 lg:w-5/12 xl:w-5/12 @if($hideStores) hidden @endif">
            <div class="relative w-full @if($hideStores) hidden @endif">
                <input
        ...
        <div class="relative md:w-4/12 lg:w-5/12 xl:w-4/12 @if($hideDates) hidden @endif">
