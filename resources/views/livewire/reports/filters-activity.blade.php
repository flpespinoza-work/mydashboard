...
>
    <form wire:submit.prevent="sendFiltersToReport" class="items-center space-y-2 md:space-y-0 md:space-x-3 xl:justify-end md:flex">
        ...
        <div class="relative md:w-4/12 lg:w-5/12 xl:w-3/12">
            <input type="text" wire:model.lazy="filters.user" id="user" placeholder="Usuario ID" class="{{ $errors->has('filters.user') ? 'border-red-300 bg-red-50' : '' }} w-full text-xs border-gray-200 rounded-sm focus:ring-gray-200 focus:border-gray-200">
        </div>
