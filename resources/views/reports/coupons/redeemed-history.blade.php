<x-app-layout>
    ...
    <x-slot name="title">
        <div class="flex items-center">
            ...
            <span class="ml-2 text-gray-800">Reporte acumulado de cupones canjeados</span>
        </div>
    </x-slot>
    <x-slot name="description">Número de cupones canjeados por el establecimiento</x-slot>
