...
class="absolute top-0 left-0 z-40 flex flex-col flex-shrink-0 h-screen max-h-full py-4 overflow-y-scroll transition-transform duration-200 ease-in-out transform bg-white border-r border-gray-150 w-72 lg:static lg:left-auto lg:top-auto lg:translate-x-0 lg:overflow-y-auto no-scrollbar">
